...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'vacation-lite' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'vacation-lite' ),
		'repeat-y'  => __( 'Repeat Vertically', 'vacation-lite' ),
		'repeat'    => __( 'Repeat All', 'vacation-lite' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'vacation-lite' ),
		'top center'    => __( 'Top Center', 'vacation-lite' ),
		'top right'     => __( 'Top Right', 'vacation-lite' ),
		'center left'   => __( 'Middle Left', 'vacation-lite' ),
		'center center' => __( 'Middle Center', 'vacation-lite' ),
		'center right'  => __( 'Middle Right', 'vacation-lite' ),
		'bottom left'   => __( 'Bottom Left', 'vacation-lite' ),
		'bottom center' => __( 'Bottom Center', 'vacation-lite' ),
		'bottom right'  => __( 'Bottom Right', 'vacation-lite')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'vacation-lite' ),
		'fixed'  => __( 'Fixed in Place', 'vacation-lite')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'vacation-lite' ),
		'bold'        => __( 'Bold', 'vacation-lite' ),
		);
